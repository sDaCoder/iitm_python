...
class Solution:
    def permutation(self, s: str) -> None:
        for i in range(len(s)):
            for j in range(len(s)):
                if i != j:
                    print(s[i] + s[j])
        
    def sorted_permutation(self, s: str) -> None:
        for i in range(len(s)):
            for j in range(len(s)):
                if i != j and s[i] < s[j]:
                    print(s[i] + s[j])
        
    def repeat_the_repeat(self, n: int) -> None:
        for j in range(n):
            for i in range(n):
                print(i + 1, end = "")
            print()
        
    def repeat_incrementally(self, n: int) -> None:
        for i in range(n):
            for j in range(i + 1):
                print(j + 1, end = "")
            print()
        
    def increment_and_decrement(self, n: int) -> None:
...
if task == 'permutation':
    ...
    s = input()
    S.sorted_permutation(s)
elif task == 'repeat_the_repeat':
    n = int(input())
    S.repeat_the_repeat(n)
elif task == 'repeat_incrementally':
    n = int(input())
    S.repeat_incrementally(n)
elif task == 'increment_and_decrement':
    n = int(input())
    S.increment_and_decrement(n)
else:
    pass